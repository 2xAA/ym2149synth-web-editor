  ...
  data() {
    return {
      ...
      ranges: [
        {
          title: "Fine-tune",
          label: "Softwave-voice / Env-voice (Software PWM)",
          value: 0,
          cc: 1,
        },
        {
          title: "Detune",
          label:
            "Softwave-voice note detune in synth type: 5, otherwise square-voice detune",
          value: 0,
          cc: 2,
        },
        {
          title: "Volume Envelope Shape",
          label: "0=OFF, 1-63=Ramp up time, 64-127=Ramp down time",
          value: 0,
          cc: 4,
        },
        ...
        {
          title: "Trigger Noise Delay",
          label: "(useful for snare tail or Env synth type effect)",
          value: 0,
          cc: 8,
        },
        { title: "Pitch Envelope Amount", value: 0, cc: 9 },
        {
          title: "Pitch Envelope Shape",
          label: "0=OFF, 1-63=Ramp up time, 64-127=Ramp down time",
          value: 0,
          cc: 10,
        },
